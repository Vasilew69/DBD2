...
var prth = /*#__PURE__*/function () {
  function prth() {
    var _this = this;

    _classCallCheck(this, prth);
  ...
  _createClass(prth, [{
    key: "init",
    value: function init() {
      // handle prth skins (default, dark)
      // =============================================================
      ...
      this.autofocusInputBehaviour(); // handle prth layouts
      // =============================================================
      ...
      this.sidebar();
      this.pageExpander(); // handle prth components
      // =============================================================
      ...
      $(document).trigger('prth:init', this);
    } // Polifyll
    // =============================================================
    ...
    value: function quill() {
      if (window.Quill) {
        $('[data-toggle="quill"]').each(function () {
          ...
          options.prth = options.prth ? options.prth : 'snow';
...
var Looper = function () {
  var Looper = new prth(); // toggle skin thought button
